...
@Component({
    selector: 'app-seafood-form',
    templateUrl: './seafood-form.component.html'
})
export class SeafoodFormComponent implements OnInit {
    ...
    constructor(
        ...
        _route.params.subscribe(p => {
            ...
            console.log('In SeafoodFormComponent entree_type is ' + entree_type + '\nsauce_id is ' + sauce_id);
