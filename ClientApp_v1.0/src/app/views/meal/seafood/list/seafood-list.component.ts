...
@Component({
    selector: 'app-seafood-list',
    templateUrl: './seafood-list.component.html'
})

export class SeafoodListComponent implements OnInit {
    ...
    { 
        _route.params.subscribe(p => {
            ...
            console.log('In SeafoodListComponent entree_type is ' + entree_type);
